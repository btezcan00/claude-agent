...
import { Folder, ActivityItem } from '@/types/folder';
...
export function FolderActivities({ folder }: FolderActivitiesProps) {
  ...
  const activities = useMemo(() => folder.activities || [], [folder.activities]);
  ...
  const handleAddActivity = (item: { date: string; phase: typeof folder.status; label: string; description: string }) => {
    addActivity(folder.id, item);
  };
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              ...
                              onClick={() => removeActivity(folder.id, activity.id)}
                            >
