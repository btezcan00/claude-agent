...
interface AddItemDialogProps {
  open: boolean;
  onClose: () => void;
  onAdd: (item: { date: string; phase: FolderStatus; label: string; description: string }) => void;
  currentPhase: FolderStatus;
  title: string;
}

export function AddItemDialog({ open, onClose, onAdd, currentPhase, title }: AddItemDialogProps) {
