...
// Common attachment type that works for both case and signal attachments
type PreviewableAttachment = (CaseAttachment | SignalAttachment) & {
  fileName: string;
  fileType: string;
  fileSize: number;
  content?: string;
...
interface CaseAttachmentPreviewDialogProps {
...
export function CaseAttachmentPreviewDialog({
  attachment,
  open,
  onClose,
}: CaseAttachmentPreviewDialogProps) {
  if (!attachment) return null;

  const isImage = IMAGE_TYPES.includes(attachment.fileType);
        ...
        <div className="mt-4">
          {!attachment.content ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p>This attachment has no file content available.</p>
