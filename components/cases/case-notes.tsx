...
export function CaseNotes({ caseItem, isAdmin = true }: CaseNotesProps) {
  const { addCaseNote, removeCaseNote } = useCases();
  ...
  const handleAddNote = () => {
    if (noteContent.trim()) {
      addCaseNote(caseItem.id, noteContent.trim(), isAdminNote);
      setNoteContent('');
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={() => removeCaseNote(caseItem.id, note.id)}
                >
